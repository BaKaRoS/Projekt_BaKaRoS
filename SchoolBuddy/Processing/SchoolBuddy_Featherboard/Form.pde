...
public class Form{
   public Form(PApplet app, float x, float y, int lineDistance, Data data1_, Data data2_){
     ...
     this.cp5.addBang("calibrate")
             .setPosition(width*0.665, height*0.3)
             .setSize((int)(width*0.15), 2*textSize)
             .setColorBackground(this.textfieldColor) //background
             .setColorForeground(this.fontColor) //inactive frame
             .setColorActive(this.activeColor) //active frame
             .setFont(textfieldFont)
     ...
     this.cp5.addTextlabel("calib")
             .setPosition(width*0.69+(int)(width*0.019), height*0.3+0.5*textSize*3/4.0)
             .setColor(this.textfieldColor) //text
             .setColorActive(this.fontColor) //active frame
             .setColorForeground(this.fontColor) //inactive frame
             .setFont(textfieldFont)
     ...
     //auswertungsbutton
     this.cp5.addBang("auswertung")
             .setPosition(width*0.655, height*0.9)
             .setSize((int)(width*0.15), 2*textSize)
             .setColorBackground(this.textfieldColor) //background
             .setColorForeground(this.fontColor) //inactive frame
             .setColorActive(this.activeColor) //active frame
             ...
             .setLabel("")
             .hide(); 
     this.cp5.addTextlabel("auswertunglabel")
             .setPosition(width*0.675+(int)(width*0.018), height*0.9+0.5*textSize*3/4.0)
             .setColor(this.textfieldColor) //text
             .setColorActive(this.fontColor) //active frame
             .setColorForeground(this.fontColor) //inactive frame
             .setFont(textfieldFont)
             ...
             .hide();
     //back
     this.cp5.addTextlabel("backlabel")
             .setPosition(width*0.685+(int)(width*0.018), height*0.9+0.5*textSize*3/4.0)
             .setColor(this.textfieldColor) //text
             .setColorActive(this.fontColor) //active frame
             .setColorForeground(this.fontColor) //inactive frame
             .setFont(textfieldFont)
     ...
     this.cp5.addBang("stop")
             .setPosition(width*0.655, height*0.95)
             .setSize((int)(width*0.15), 2*textSize)
             .setColorBackground(this.textfieldColor) //background
             .setColorForeground(this.fontColor) //inactive frame
             .setColorActive(this.activeColor) //active frame
     ...
     this.cp5.addTextlabel("stoprecord")
             .setPosition(width*0.66+(int)(width*0.018), height*0.95+0.5*textSize*3/4.0)
             .setColor(this.textfieldColor) //text
             .setColorActive(this.fontColor) //active frame
             .setColorForeground(this.fontColor) //inactive frame
             .setFont(textfieldFont)
             .setValue("Speichern & Beenden")
             .hide();
   ...
   public void save(){
     ...
     this.cp5.getController("auswertung").show();
     this.cp5.getController("auswertunglabel").show();
     this.cp5.getController("backlabel").hide();
   } 
...
public void auswertung() {
  if(screen.getWindow() == 0){
    //auswertung
   screen.setWindow(1);
   screen.getForm().getCp5().getController("auswertunglabel").hide();
   screen.getForm().getCp5().getController("backlabel").show();
  }else{
    //momentanaufnahme
    screen.setWindow(0);
    screen.getForm().getCp5().getController("backlabel").hide();
    screen.getForm().getCp5().getController("auswertunglabel").show();
  }
}